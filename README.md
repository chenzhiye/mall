...
　　作者开发电脑局域网IP：192.168.5.20，服务器的局域网IP：192.168.0.175，要保证网络畅通，防火墙配置正确。<br>
...
```
    ...
    tx-lcn:
      client:
        manager-address: 192.168.0.175:8070
        resource-order: 0
      logger:
        enabled: false
      message:
...
spring.datasource.url=jdbc:mysql://192.168.0.175:3306/tx-manager?characterEncoding=UTF-8
...
tx-lcn.manager.host=192.168.0.175
...
network.publish_host: 192.168.0.175
```
...
> curl -XPUT http://192.168.0.175:9200/index
...
> curl 'http://192.168.0.175:9200/index/_analyze?analyzer=ik_max_word&pretty=true' -d '{"text":"我们是大数据开发技术人员"}'
...
> http://192.168.0.175:7970/

**#config-server**

> http://192.168.0.175:2001/service-member-dev.yml

> http://192.168.0.175:2001/service-member-test.yml

> http://192.168.0.175:2001/service-member-prd.yml

> http://192.168.0.175:2001/service-product-dev.yml

> http://192.168.0.175:2001/service-product-test.yml

> http://192.168.0.175:2001/service-product-prd.yml

> http://192.168.0.175:2001/service-order-dev.yml

> http://192.168.0.175:2001/service-order-test.yml

> http://192.168.0.175:2001/service-order-prd.yml

> http://192.168.0.175:2001/actuator/bus-refresh POST
